...
# Map with SNP Labeled: for SETAC 2023 (Louisville, KY) conference talk
# SEKI <- data.frame(long = -118.667387, lat = 36.601038, name = "Sequoia National Park")
#  UTM: Easting = 350864.81, Northing = 4051909.77
# NAD83 / California Albers: x = 119055, y = -156489
...
ggplot() +
  ...
  scale_fill_distiller(name = "Total Kilograms",
                     ...
                     palette = "Oranges",
                     na.value = "grey99") +
  geom_point(aes(x = 119055, y = -156489), 
             size = 4, color = "black") + 
  geom_curve(aes(x = 119055+300000, y = -156489+50000, xend = 119055, yend = -156489), 
             arrow = arrow(), size = 1.5, color = "blue") + 
  geom_label(aes(x = 119055, y = -156489, label = "Sequoia\nNational Park"), 
             size = 5, nudge_x = 300000, nudge_y = 80000, show.legend = FALSE) + 
  theme(text = element_text(family = "Lato"),
  ...
  labs(title = "Kg of Cu Pesticide Applied per Township in 2021",
       x = NULL,
       y = NULL)
...
allCu_map <- 
  mapview(plss_allCu_tr_all[plss_allCu_tr_all$YEAR == 2021,],
          zcol = "sum_kg_applied",
          col.region = pal,
          layer.name = "Total Kilograms Cu Applied in 2021",
          popup = popupTable(plss_allCu_tr_all[plss_allCu_tr_all$YEAR == 2021,],
                             zcol = c("NAME", "TownshipRa", "sum_kg_applied"))) + 
